...
async function downloader_jd() {
    ...
    if (remoteContent.indexOf("jdFruitShareCodes") > 0) {
        await download(
            "https://github.com/ys6666/Kieeeee/raw/main/jdFruitShareCodes.js",
    ...
    if (remoteContent.indexOf("jdPetShareCodes") > 0) {
        await download(
            "https://github.com/ys6666/Kieeeee/raw/main/jdPetShareCodes.js",
            "./jdPetShareCodes.js",
            "京东萌宠"
        );
    }
    if (remoteContent.indexOf("jdPlantBeanShareCodes") > 0) {
        await download(
            "https://github.com/ys6666/Kieeeee/raw/main/jdPlantBeanShareCodes.js",
    ...
    if (remoteContent.indexOf("jdFactoryShareCodes") > 0) {
        await download(
            "https://github.com/ys6666/Kieeeee/raw/main/jdFactoryShareCodes.js",
    ...
    if (remoteContent.indexOf("jdDreamFactoryShareCodes") > 0) {
        await download(
            "https://github.com/ys6666/Kieeeee/raw/main/jdDreamFactoryShareCodes.js",
